...
export default function NotFoundPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F6F5] flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="text-5xl font-bold text-[#153b50] mb-2">404</p>
      ...
      <div className="flex flex-col gap-3 w-full max-w-xs">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center justify-center gap-2 px-6 py-2.5 bg-[#153b50] text-white text-sm font-medium rounded-xl hover:bg-[#153b50]/90 transition"
        >
          <MdArrowBack size={16} />
          Voltar
        </button>
        <button
          ...
          className="flex items-center justify-center gap-2 px-6 py-2.5 border border-gray-200 text-gray-600 text-sm font-medium rounded-xl hover:border-[#b2f0fb] transition"
        >
          <MdHome size={16} />
          Ir para o início
        </button>
